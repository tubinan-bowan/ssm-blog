                    ...
                    <div class="status_list_item icon_kyubo">
                        <div class="status_user" style="background-image: url(statics/images/b0ce3f3cde0c084b6d42321b2dcbc407.jpeg);">
                            <div class="status_section">
                                <a href="blogDetail?id=${blog.id}" class="status_btn">${blog.title}</a>
                                <p class="section_p">${blog.content}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row review-item-wrapper">
                                ...
                                <div class="col-sm-9 flex-xs-middle">
                                    <div class="review-item-title">
                                        <a href="blogDetail?id=${blog.id}" rel="bookmark">${blog.title}</a>
                                    </div>
                                    <div class="review-item-creator"><b>发布日期：</b>${blog.createTime}</div>
...
<footer id="footer" class="overlay animated from-top">
    ...
    <script type='text/javascript' src='statics/js/blog_script.js'></script>
