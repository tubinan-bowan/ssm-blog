    ...
    <div class="c-panel">
        ...
        <el-form :inline="true" size="mini">
            ...
            <el-form-item style="min-width: 10px;">
                <el-button type="primary" icon="el-icon-search" @click="getBlogList">查询</el-button>
            </el-form-item>
            <br>
        ...
        <el-table class="data-table" :data="dataList" size="mini">
            ...
            <el-table-column label="发表人" prop="author"></el-table-column>
            <el-table-column label="发表于" prop="createTime"></el-table-column>
        ...
        <%--<div class="page-box">
            <el-pagination background
                           ...
                           @current-change="getBlogList(true)"
                           @size-change="getBlogList(true)">
            </el-pagination>
        </div>--%>
    </div>
</div>
