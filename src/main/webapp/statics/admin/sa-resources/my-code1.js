...
// 设置模板标题 
sa_admin.title = "study博客后台";
sa_admin.logo_url = 'statics/admin/sa-resources/admin-logo.png';    // 设置logo图标地址   默认值：sa-resources/admin-logo.png
sa_admin.icon_url = 'statics/admin/sa-resources/admin-logo.png';    // 设置icon图标地址   默认值：sa-resources/admin-logo.png
...
sa_admin.user = {
	username: 'root',	// 昵称 
	avatar: 'statics/admin/sa-resources/admin-logo.png'	// 头像地址
}
